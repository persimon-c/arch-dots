...
() {
  ...
  # Default background color — rich mauve/purple.
  typeset -g POWERLEVEL9K_BACKGROUND='#2a1f3d'
  # Separator between same-color segments on the left.
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%F{#6e548a}\uE0B1'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%F{#6e548a}\uE0B3'
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=$P10K_COLOR_MAUVE
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='#1e1530'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#e0d7ff'
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#3b2d5c'
