...
//@ pragma StateDir <dir>
//@ pragma CacheDir <dir>
Quickshell defines default data, state, and cache directories based off the shell id and exposed by Quickshell.dataDir, Quickshell.stateDir and Quickshell.cacheDir.
