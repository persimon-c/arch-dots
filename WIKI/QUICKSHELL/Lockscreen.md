Quickshell.Services.Greetd Definitions
Greetd integration
Greetd
GreetdState
...
Modules
Pam works with a set of modules that handle various authentication mechanisms. Some common ones include pam_unix.so which handles passwords and pam_fprintd.so which handles fingerprints.
